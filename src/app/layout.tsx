...
export const metadata: Metadata = {
  ...
  icons: [
    ...
    {
      rel: "icon",
      url: "favicons/logo_guava_aleson_16.png",
      type: "image/png",
      sizes: "16x16",
    },
    {
      rel: "icon",
      url: "favicons/logo_guava_aleson_32.png",
      type: "image/png",
      sizes: "32x32",
    },
    {
      rel: "apple-touch-icon",
      url: "favicons/logo_guava_aleson_180.png",
      type: "image/png",
      sizes: "180x180",
    },
    {
      rel: "icon",
      url: "favicons/logo_guava_aleson_256.png",
      type: "image/png",
      sizes: "256x256",
    },
    {
      rel: "icon",
      url: "favicons/logo_guava_aleson_512.png",
      type: "image/png",
      sizes: "512x512",
    },
  ],
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://alesonestevam.com/favicons/logo_guava_aleson_16.png',
        width: 16,
        height: 16,
        alt: 'Logo Aleson Estevam',
      },
      {
        url: 'https://alesonestevam.com/favicons/logo_guava_aleson_32.png',
        width: 32,
        height: 32,
        alt: 'Logo Aleson Estevam',
      },
      {
        url: 'https://alesonestevam.com/favicons/logo_guava_aleson_180.png',
        width: 180,
        height: 180,
        alt: 'Logo Aleson Estevam',
      },
      {
        url: 'https://alesonestevam.com/favicons/logo_guava_aleson_256.png',
        width: 256,
        height: 256,
        alt: 'Logo Aleson Estevam',
      },
      {
        url: 'https://alesonestevam.com/favicons/logo_guava_aleson_512.png',
        width: 512,
        height: 512,
        alt: 'Logo Aleson Estevam',
      },
